...
# aria2c -x 8 http://curtis.ml.cmu.edu/datasets/hotpot/hotpot_train_v1.1.json -o raw_data/hotpotqa/hotpot_train_v1.1.json
# aria2c -x 8 http://curtis.ml.cmu.edu/datasets/hotpot/hotpot_dev_distractor_v1.json -o raw_data/hotpotqa/hotpot_dev_distractor_v1.json

echo "\n\nDownloading raw 2wikimultihopqa data\n"
mkdir -p raw_data/2wikimultihopqa
wget 8 https://www.dropbox.com/s/7ep3h8unu2njfxv/data_ids.zip?dl=0 -O .temp/2wikimultihopqa.zip
...
aria2c -x 8 https://iirc-dataset.s3.us-west-2.amazonaws.com/iirc_train_dev.tgz -o .temp/iirc_train_dev.tgz
...
aria2c -x 8 https://iirc-dataset.s3.us-west-2.amazonaws.com/context_articles.tar.gz -o .temp/context_articles.tar.gz
tar -xzvf .temp/context_articles.tar.gz -C raw_data/iirc

echo "\n\nDownloading hotpotqa wikipedia corpus (this will take ~5 mins)\n"
aria2c -x 8 https://nlp.stanford.edu/projects/hotpotqa/enwiki-20171001-pages-meta-current-withlinks-abstracts.tar.bz2 -o .temp/wikpedia-paragraphs.tar.bz2
